      ...
      <div class="container mx-auto">
        <div class="grid grid-cols-1 xl:grid-cols-2 px-4 py-4 gap-4">
          <div v-for="resource in resources" :key="resource.title">
            <div class="border rounded flex h-full">
    ...
    resources: function () {
      const resources = [
        new Resource(
          ...
          "Angular",
          "After a thorough investigation of the major frontend frameworks (Angular, React and Vue) I started working with Angular. I love backend, but I also care about frontend. I want my code to be neat and structured. A frontend framework like Angular makes this possible for complex systems."
        ),
        new Resource(
        ...
        new Resource(
          ...
          "MaterializeCSS",
          "I'm a full stack developer. This means I work on the frontend and backend. Designing (web) applications is a different job. Luckily there are frontend frameworks like MaterializeCSS which make applications I write look and feel great."
        ),
        new Resource(
          "/img/linux-logo.svg",
          "Linux",
          "When I was in my teens you could still fill in a form on the Ubuntu website and order a physical CD for free. Growing up with Microsoft Windows, this was an entire new world. I always had an old PC laying around and loved discovering a new Linux distro on it. A couple of distro's I'm familiar with are Ubuntu, OpenSUSE, Debian, Red Hat, Fedora, Linux Mint. My distro of choice is Ubuntu."
        ),
        new Resource(
          "/img/php-logo.png",
          "PHP",
        ...
        new Resource(
          "/img/python-logo.svg",
          "Python",
          "Python has intrigued me in early 2020. Elegant code has always been a goal of mine and when I heard of Pythonic code, I had to check it out. Since it's a solid language with a huge community and gaining popularity (especially the last couple of years) I started a couple of side projects with it. It's perfect for small or MVP projects."
        ),
        new Resource(
        ...
        new Resource(
          "/img/vue-logo.svg",
          "Vue",
          "I started working at a company that was using Vue as their main frontend framework. Learning Vue was really easy coming from Angular. The simplicity, efficiency and performance made me see that Vue is an awesome frontend framework to work with."
        ),
        new Resource(
          "/img/inertia-logo.png",
          "Inertia.js",
          "Inertia.js is kind of like a bridge for backend developers to frontend and vice versa. It makes it very easy to create a monolithic SPA. This saves a LOT of time and makes the user experience as great as any SPA with an API behind it. It's just amazing."
        ),
        new Resource(
          "/img/tailwind-css-logo.svg",
          "Tailwind CSS",
          "Tailwind CSS let's me create beautiful user interfaces extremely fast. I'll be honest, when I started working with it I was sceptical. Will it not clutter my HTML? But if you use the tool correctly, it won't. Another great frontend framework which helps me build awesome apps."
        ),
      ];
